...
- Python: **3.8+** and still supported. See [Python Developer's Guide](https://devguide.python.org/versions/) for supported versions.
- [pykakasi](https://codeberg.org/miurahr/pykakasi) (to parse Japanese phrase)
